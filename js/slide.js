export function openSlide(slidePage) {
...
export function closeSlide(slidePage) {
    if (!slidePage.classList.contains("closeSlide")) {
...
export function updateSelectProject(selectProject, newSelectProject) {
...
export function getInfoProject(itemProject) {
...
export function insertInfoInSlide(slidePage, info) {
